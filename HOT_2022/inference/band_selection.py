...
from HOT_2022.HASBS.has_bs.has_bs import HAS_BS
from HOT_2022.inference.new_helper import crop_image, X2Cube, X2Cube2

msbabs_16 = HAS_BS(in_channels=16)
pretrained_ = torch.load("weights/band_2022.pth")
